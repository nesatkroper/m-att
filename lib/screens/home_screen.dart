...
class HomeScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void openQrScanner() async {
      ...
      // Process QR scan result if available
      if (result != null && result is String && authProvider.currentEmployee != null) {
        await attendanceProvider.processQrScan(result, authProvider.currentEmployee!.id);
      }
    }
      ...
      return RefreshIndicator(
        ...
        child: recentRecords.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final record = recentRecords[index];
                  return _buildAttendanceHistoryItem(record, theme, colorScheme);
                },
              ),
      );
    }
              ...
              child: leaveRequests.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _buildLeaveRequestItem(request, theme, colorScheme);
                      },
                    ),
            ),
          ],
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: (attendanceProvider.scanSuccess ? Colors.green : Colors.red)
                                .withOpacity(0.3),
                            blurRadius: 8,
                            offset: const Offset(0, 4),
                          ),
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              attendanceProvider.scanSuccess
                                  ? attendanceProvider.todayRecord?.status == 'checked-in'
                                      ? 'Successfully checked in!'
                                      : 'Successfully checked out!'
                                  : attendanceProvider.error ?? 'Scan failed',
                              style: const TextStyle(
