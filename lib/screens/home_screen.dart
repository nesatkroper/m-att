...
class HomeScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final viewMode = useState('weekly');
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: selectedTabIndex.value == 0
            ? Text(getGreeting())
            : Text(selectedTabIndex.value == 1
                ? 'Attendance History'
                : 'Leave Requests'),
        elevation: 0,
        ...
        actions: [
          ...
          // View mode toggle (weekly/monthly) for attendance summary
          if (selectedTabIndex.value == 0 || selectedTabIndex.value == 1)
            IconButton(
              icon: Icon(viewMode.value == 'weekly'
                  ? Icons.calendar_month
                  : Icons.view_week),
              onPressed: () => viewMode.value =
                  viewMode.value == 'weekly' ? 'monthly' : 'weekly',
              tooltip: viewMode.value == 'weekly'
